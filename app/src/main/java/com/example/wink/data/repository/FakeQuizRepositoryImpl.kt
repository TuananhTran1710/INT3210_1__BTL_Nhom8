...
class FakeQuizRepositoryImpl @Inject constructor(): QuizRepository {
    val sampleQuizzes = listOf(
        ...
        Quiz(
            id = "rizz_005",
            title = "Nghệ Thuật Trêu Đùa (Teasing)",
            description = "Sử dụng sự hài hước để xây dựng kết nối.",
            rizzUnlockCost = 50,
            questions = listOf(
        ...
        Quiz(
            id = "rizz_006",
            title = "Xây Dựng Sự Tin Tưởng",
            description = "Các bước để cô ấy tin tưởng và mở lòng với bạn.",
            rizzUnlockCost = 50,
            questions = listOf(
        ...
        Quiz(
            id = "rizz_007",
            title = "Tán Gái qua Tin Nhắn",
            description = "Kỹ năng nhắn tin đỉnh cao, giữ lửa cuộc trò chuyện.",
            rizzUnlockCost = 50,
            questions = listOf(
        ...
        Quiz(
            id = "rizz_008",
            title = "Phát Triển Mối Quan Hệ",
            description = "Từ hẹn hò đến mối quan hệ nghiêm túc, bạn cần làm gì.",
            rizzUnlockCost = 50,
            questions = listOf(
        ...
        Quiz(
            id = "rizz_009",
            title = "Lôi Cuốn và Độc Lập",
            description = "Sự tự tin và giá trị cá nhân thu hút cô gái.",
            rizzUnlockCost = 50,
            questions = listOf(
        ...
        Quiz(
            id = "rizz_010",
            title = "Sự Hài Hước Tinh Tế",
            description = "Cách dùng hài hước để cưa đổ nàng.",
            rizzUnlockCost = 50,
            questions = listOf(
